  ...
  return (
    <footer className="mt-auto text-black">
      <div className="px-4 py-10 lg:px-0">
        <div className="mx-auto max-w-screen-xl grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4">
          <div className="text-center sm:text-left">
            ...
            <ul className="mt-8 space-y-4 text-sm">
              <li>
                <a
                  className="text-black transition hover:text-gray-100/75"
                  href="#"
                >
                  Company History
                </a>
            ...
            <ul className="mt-8 space-y-4 text-sm">
              ...
              <li>
                <a
                  ...
                  href="#"
                >
                  <span className="text-black transition group-hover:text-gray-100/75">
                    Live Chat
                  </span>
            ...
            <ul className="mt-8 space-y-4 text-sm">
              <li>
                ...
                >
                  ...
                  <span className="flex-1 text-black">john@doe.com</span>
                </a>
              </li>
      ...
      <div className="text-sm">
        <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <ul className="mt-5 flex flex-wrap justify-center divide-x divide-gray-500">
            <li className="px-3">
              <a
      ...
      <div className="bg-black">
        <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-6 max-w-md text-center text-base leading-relaxed text-white">
